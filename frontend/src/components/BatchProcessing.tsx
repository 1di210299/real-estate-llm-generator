              ...
              <div className="flex gap-3">
                {isProcessing ? (
                  ...
                  <button
                    ...
                    className="flex-1 bg-gradient-to-r from-purple-600 via-purple-600 to-indigo-600 text-white py-4 px-4 rounded-xl hover:from-purple-700 hover:to-indigo-700 transition-all duration-200 font-bold text-sm flex items-center justify-center gap-3 disabled:opacity-50 disabled:cursor-not-allowed shadow-xl hover:shadow-2xl hover:scale-105 transform disabled:hover:scale-100"
                  >
                    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  {batchItems.map((item, index) => (
                    <div 
                      ...
                      className={`p-1.5 transition-all duration-300 ${
                        index === currentProcessingIndex ? 'bg-blue-50 border-l-4 border-blue-500 shadow-md' : 'hover:bg-gray-50'
                      }`}
                    >
                      <div className="flex items-start gap-2">
                        <div className={`flex-shrink-0 w-6 h-6 rounded-full flex items-center justify-center font-bold text-[10px] transition-all ${
